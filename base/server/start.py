...
#!nix-shell -i python3 -p python3 python3Packages.psutil python3Packages.rich rsync systemd
...
RSYNC_DIRS = ["config", "world", "journeymap", "schematics", "defaultconfigs", "configureddefaults", "kubejs", "moonlight-global-datapacks", "patchouli_books"]
