...
<contenttweaker:will_ensnaring_fabrial>.addTooltip(format.red("To make the potions better to use the Potion Brewer, the Alchemical Imbuer chain can lead to bugs"));
<contenttweaker:will_ensnaring_fabrial>.addTooltip(format.red("Jump Boost: Nether Wart, Rabbit's Foot"));
<contenttweaker:will_ensnaring_fabrial>.addTooltip(format.red("Haste: Nether Wart, Ender Pearl, Cookie, Glowstone Dust"));
<contenttweaker:will_ensnaring_fabrial>.addTooltip(format.red("Water Breathing: Nether Wart, Pufferfish"));
...
<contenttweaker:black_hole_juice>.addTooltip(format.red("Ariel_Shigure (solo)"));


<avaritia:infinity_sword>.addTooltip(format.red("They who achieved eternal glory:"));
<avaritia:infinity_sword>.addTooltip(format.red("红砖 (solo)"));
<avaritia:infinity_sword>.addTooltip(format.red("𓆩♡𓆪 Becky 𓆩⟡𓆪 (solo)"));



<thebetweenlands:items_misc:24>.addTooltip(format.red("Thanks to origami10004 and okay with the help buffing mythic miners"));

<contenttweaker:fluix_fossilization_fabrial>.addTooltip(format.green("Reusable"));

<contenttweaker:evertainted_pebble>.addTooltip(format.red("Right click the mob summoned from the Void Ichorium Jewel"));

<contenttweaker:crimson_sundering_pebble>.addTooltip(format.red("Right click on various mobs in the Twilight Forest"));

<bloodmagic:lava_crystal>.addTooltip(format.red("WARNING: do not craft in the fluid assembler, it will delete the blood orb"));

<contenttweaker:crimson_warren_remains>.addTooltip(format.red("Right click the Sundering of the Twilit Curse nearby the Crimson Cult Structures in the Twilight Forest"));

<contenttweaker:sundering_of_the_twilit_curse>.addTooltip(format.red("Right click nearby the Crimson Cult Structures in the Twilight Forest"));

<contenttweaker:breath_of_ragnarok>.addTooltip(format.green("Reusable"));

<ore:oreTungsten>.addTooltip(format.red("Thanks to DarkSpace, the Induction Smelter recipe works"));

<contenttweaker:vengeful_asgardian_crystal>.addTooltip(format.red("With regards to Hex and Ellie"));

<contenttweaker:essence_of_the_balanced_warrior>.addTooltip(format.red("ProPlaysForMe had some feedback..."));


<contenttweaker:standard_of_the_dragon_reborn>.addTooltip(format.green("Reusable"));
...
<ae2powertools:auto_crafter>.addTooltip(format.red("Thanks to Aedial for giving us more AE2 goodies!"));


<minecraft:fish>.addTooltip(format.red("shiraori_gd has got the jokes"));

<twilightforest:giant_pickaxe>.addTooltip(format.red("I like IridumSky's sense of humor"));

<thaumadditions:mithminite_smelter>.addTooltip(format.red("MaGeBZz wants tooltips to be pretty"));


<contenttweaker:bionic_construct>.addTooltip(format.green("Reusable"));
...
<contenttweaker:summons_of_the_twilit_hero>.addTooltip(format.red("Replace the top middle portal block in the Crepuscular Callstone with a Twilit Freedom Fabrial"));
<contenttweaker:summons_of_the_twilit_hero>.addTooltip(format.red("Stand on top of it, and use the Summons of the Twilit Hero"));

<contenttweaker:unforgotten_summons>.addTooltip(format.green("Reusable"));
<contenttweaker:unforgotten_summons>.addTooltip(format.red("Right click the mob summoned by Summons of the Twilit Hero with a Fiery Sword"));

<contenttweaker:flame_of_actualization>.addTooltip(format.green("Reusable"));

<contenttweaker:offering_to_the_eleint_of_actualization>.addTooltip(format.red("Right click the friendly mob summoned by the Key of Actualization"));

<chisel:chisel_diamond>.addTooltip(format.red("Can be crafted into an unbreakable version"));

<aoa3:gauge_rifle>.addTooltip(format.red("Traded by the Lelyetia Trader"));

<contenttweaker:mythic_processor_centrifuge>.addTooltip(format.red("The Mythic Processor Centrifuge works with Fluid Cells"));

<techreborn:dynamiccell>.withTag({Fluid: {FluidName: "sednanite", Amount: 1000}}).addTooltip(format.red("Mewmeister does not want us to have nice things (thanks for finding a bug)"));

<abyssalcraft:dreadaltarbottom>.addTooltip(format.red("Place bottom at y = 40 in the Dreadland Mountains biome"));

<abyssalcraft:dreadaltartop>.addTooltip(format.red("Place bottom at y = 40 in the Dreadland Mountains biome"));


<aether_legacy:lightning_knife>.addTooltip(format.red("I am a big fan of gambling, of the Bronze Aether variety"));
...
<contenttweaker:ingot_of_infinite_wishes>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));

<contenttweaker:mana_antenna>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));

<contenttweaker:awakened_mithril>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:awakened_mithril_alloy>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));

<contenttweaker:bifrost_warren_dust>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:brightsteel_alloy_plate_of_the_one_power>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:chaotic_mithril_alloy>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:flame_of_actualization>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:hopebringer_metal>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:offering_to_the_eleint_of_actualization>.addTooltip(format.red("Thanks to NerdySpider for all the Hyperuranion part texture!"));
<contenttweaker:kanohi_mask>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:ragnarok_warren_dust>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
<contenttweaker:valhalla_warren_dust>.addTooltip(format.red("Thanks to NerdySpider for the texture!"));
...
<contenttweaker:stone_of_infinite_creativity>.addTooltip(format.red("Thanks to GalacticSilver for the texture!"));
<contenttweaker:stone_of_endowed_free_will>.addTooltip(format.red("Thanks to GalacticSilver for the texture!"));
...
<woot:exporter>.addTooltip(format.red("Use with the Import Interface with a Trash Unselected Card for optimal performance"));

<tinymobfarm:ultimate_farm>.addTooltip(format.red("Use with the Import Interface with a Trash Unselected Card for optimal performance"));

<contenttweaker:chaotic_nexus>.addTooltip(format.red("Use a Staff of Power with tier 3 upgrades for: Attack damage, Dig Speed, Dig AOE, RF Capacity, Attack AOE"));

<contenttweaker:blue_matter>.addTooltip(format.red("The first one is obtained in the Valonite Gateway"));

<bewitchment:oak_spirit>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:spruce_heart>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:birch_soul>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:cloudy_oil>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:acacia_resin>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:ebb_of_death>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:droplet_of_wisdom>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:liquid_witchcraft>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:essence_of_vitality>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:cleansing_balm>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:demonic_elixir>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:fiery_unguent>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:swirl_of_depths>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:oil_of_vitriol>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:otherworldly_tears>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
<bewitchment:heaven_extract>.addTooltip(format.red("NOTE: multiblock recipes with this as an input may not work, you can use the bottle version instead"));
