...
//	suit of the fallen legion
{
	...
	//	Recipe
	mods.extendedcrafting.TableCrafting.addShaped(SuperEnchantedItem(<aoa3:hazmat_boots>.withTag({Unbreakable: 1 as byte, ncRadiationResistance: 10.0, display: {Name:"§6§oBoots of the Fallen Legion§r",Lore:["§d§oSuper-Enchanted§r"]}}), enchlistFallenLegion).getItem(), 
...
//	Gungnir
{
	...
	//	Recipe
	mods.extendedcrafting.TableCrafting.addShaped(SuperEnchantedItem(<aoa3:lelyetian_greatblade>.withTag({display: {Name:"§6§oGungnir§r",Lore:["§d§oSuper-Enchanted§r"]}}), enchlistGungnir).getItem(), 
...
//	Niernen
{
	...
	//	Recipe
	mods.extendedcrafting.TableCrafting.addShaped(SuperEnchantedItem(<aoa3:noxious_greatblade>.withTag({display: {Name:"§6§oNiernen§r",Lore:["§d§oSuper-Enchanted§r"]}}), enchlistNiernen).getItem(), 
...
//	Millennium Blade
{
	...
	//	Recipe
	mods.extendedcrafting.TableCrafting.addShaped(SuperEnchantedItem(<aoa3:millennium_greatblade>.withTag({display: {Name:"§6§o千年ロッド§r",Lore:["§d§oSuper-Enchanted§r"]}}), enchlistMillenium).getItem(), 
