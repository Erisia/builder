...
fractallitefurnacehyperuranion3.addItemInput(<contenttweaker:recursion_of_dimensional_ascension>.withTag({display: {Lore: ["§d§oShell I§r"]}}));
...
fractallitefurnacehyperuranion4.addItemInput(<contenttweaker:recursion_of_dimensional_ascension>.withTag({display: {Lore: ["§d§oShell II§r"]}}));
...
fractallitefurnacehyperuranion5.addItemInput(<contenttweaker:recursion_of_dimensional_ascension>.withTag({display: {Lore: ["§d§oShell III§r"]}}));
...
fractallitefurnacehyperuranion6.addItemInput(<contenttweaker:recursion_of_dimensional_ascension>.withTag({display: {Lore: ["§d§oShell IV§r"]}}));
...
fractallitefurnacehyperuranion7.addItemInput(<contenttweaker:recursion_of_dimensional_ascension>.withTag({display: {Lore: ["§d§oShell V§r"]}}));
