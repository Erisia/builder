...
<contenttweaker:hand_of_dominion>.addTooltip(format.red("You need around 3000 power to summon the boss"));
...
<contenttweaker:wing_of_worship>.addTooltip(format.red("You need around 3000 power to summon the boss"));
