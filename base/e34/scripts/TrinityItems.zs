...
calloftheberserker.itemRightClick = function(stack, world, player, hand) {
    ...
    Commands.call("/summon twilightforest:minoshroom ~ ~4 ~ {HandItems:[{Count:1,id:\"aoa3:rockbasher_sword\"},{}],HandDropChances:[1.0f,0.0f],Attributes:[{Name:generic.maxHealth, Base:100000.0},{Name:generic.attackDamage, Base:10000.0}],Health:100000f,CustomName:\"Fungal Apostle\"}", player, world, false, true);
...
riteofbloodshed.itemRightClick = function(stack, world, player, hand) {
    ...
    Commands.call("summon bewitchment:demon ~ ~3 ~ {CustomName:\"Alazoneia, Harbinger of Bloodshed\",recipeList:{Recipes:[{buy:{id:\"contenttweaker:marrow_of_alazoneia\",Count:1},sell:{id:\"contenttweaker:everbloody_flask\",Count:1},rewardExp:0b,maxUses:9999999}]},HandItems:[{Count:1,id:\"contenttweaker:marrow_of_alazoneia\"},{}],HandDropChances:[1.0f,0.0f],ForgeCaps:{\"twilightforest:cap_shield\":{tempshields:30,permshields:30}},Attributes:[{Name:generic.maxHealth, Base:90000.0},{Name:generic.attackDamage, Base:300.0}],Health:90000f}", player, world, true, true);
    stack.shrink(1);
    return "PASS";
