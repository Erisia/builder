...
<aoa3:blank_realmstone>.addTooltip(format.darkRed("WARNINGS:"));
<aoa3:blank_realmstone>.addTooltip(format.red("  This item should be unobtainable"));
<aoa3:blank_realmstone>.addTooltip(format.red("  If you got your grubby little hands on it intentinally, stop, it's not cool to cheat..."));
<aoa3:blank_realmstone>.addTooltip(format.red("  If a bug got you this, please report it :)"));
